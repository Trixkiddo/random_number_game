...
const play = () => {
  ...
  let userNumber = parseInt(document.querySelector(".question"));
  // essai démarré à 1
  let attempts = 1;
  ...
  while (userNumber != getRandomNum) {
    ...
    const hint = (userNumber < getRandomNum) ? higherOrLower.insertAdjacentHTML('beforeend', '<div class="higher"> Its higher !</div>') : higherOrLower.insertAdjacentHTML('beforeend', '<div class="lower"> Its lower !</div>');
